...
class SVM_ProductClassifier:
    ...
    def load_latest_model(self):
        model_folder = 'train_folder/train_saves_rf'
    ...
    def train_model(self):
        ...
        if self.model is None:
            self.model = RandomForestClassifier(probability=True, random_state=1)
    ...
    def save_model(self):
        ...
        new_model_filename = os.path.join(model_folder, f'model_rf_{timestamp}.pkl')
