...
class ProductClassifier:
    ...
    def train_model(self, base_model):
        ...
        if self.model is None:
            self.model = base_model   #MultinomialNB()
    ...
    def save_model(self):
        ...
        new_model_filename = os.path.join(model_folder, f'model_{timestamp}.pkl')
    ...
    def predict_tags(self, df_test):
        ...
        return df_predict[['name','tag','tag_updated_at']]  #[['id', 'name', 'current_price', 'tag', 'tag_updated_at']]
